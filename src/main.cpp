...
void loop() {
    ...
    if (newDataReady) {
        ...
        // Serial.printf("time: %d\nacc.x: %7.2f\nacc.y: %7.2f\nacc.z: %7.2f\n", millis(), acc.acceleration.x, acc.acceleration.y, acc.acceleration.z);
        // Serial.printf("gyro.x: %7.2f\ngyro.y: %7.2f\ngyro.z: %7.2f\n", gyro.gyro.x, gyro.gyro.y, gyro.gyro.z);
        // Serial.printf("deg_gyro_x: %7.2f\ndeg_gyro_y: %7.2f\ndeg_gyro_z: %7.2f\n", deg_gyro_x, deg_gyro_y, deg_gyro_z);
        // Serial.printf("deg_gyro_z: %7.2f\n", deg_gyro_z);
        // Serial.printf("deg_acc_z: %7.2f\n", -Total_angle[2]);
        ...
        // Serial.printf("timeDif: %7f\n", timeDif);
        // Serial.printf("gyro.gyro.z: %7.2f\n", gyro.gyro.z);
        Serial.printf("\r\n");
        // delay(10);
        newDataReady = 0;
    }
